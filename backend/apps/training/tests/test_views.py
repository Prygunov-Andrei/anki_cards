...
class TestSessionUtils:
    ...
    def test_build_card_queue_all_cards(self):
        ...
        from apps.training.session_utils import build_card_queue
        from apps.cards.models import Card
        from datetime import timedelta
    ...
    def test_estimate_session_time(self):
        ...
        from apps.training.session_utils import estimate_session_time
    ...
    def test_limit_cards_by_time(self):
        ...
        from apps.training.session_utils import limit_cards_by_time
        from apps.cards.models import Card
