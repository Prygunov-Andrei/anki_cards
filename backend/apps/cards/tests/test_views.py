...
from apps.cards.models import GeneratedDeck, UserPrompt, Deck, Token, TokenTransaction, Card, PartOfSpeechCache
from apps.cards.utils import create_card_model, create_deck, generate_apkg, parse_words_input
from apps.cards.prompt_utils import get_user_prompt, get_or_create_user_prompt, reset_user_prompt_to_default
from apps.cards.default_prompts import get_default_prompt, format_prompt, get_image_prompt_for_style, IMAGE_PROMPTS
...
class TestAutoGeneration:
    ...
    def test_generate_deck_name(self, mock_client):
        ...
        from apps.cards.llm_utils import generate_deck_name
    ...
    def test_detect_category(self, mock_client):
        ...
        from apps.cards.llm_utils import detect_category
    ...
    def test_select_image_style(self):
        ...
        from apps.cards.llm_utils import select_image_style
...
class TestTokenService:
    ...
    def test_spend_tokens(self):
        ...
        from apps.cards.token_utils import spend_tokens, add_tokens
    ...
    def test_refund_tokens(self):
        ...
        from apps.cards.token_utils import refund_tokens, add_tokens, spend_tokens
    ...
    def test_check_balance(self):
        ...
        from apps.cards.token_utils import check_balance, add_tokens
...
class TestTokenAPI:
    ...
    def test_get_transactions(self):
        ...
        from apps.cards.token_utils import add_tokens, spend_tokens
