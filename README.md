...
- **[Установка и настройка](./docs/getting-started/setup.md)** — полное руководство по установке
- **[Workflow разработки](./docs/getting-started/workflow.md)** — ежедневный workflow ⭐
- **[API Документация](./docs/api/README.md)** — все API endpoints
- **[Архитектура](./docs/architecture/README.md)** — структура проекта
- **[Деплой](./docs/deployment/DEPLOYMENT.md)** — инструкция по деплою 🚀
- **[План разработки](./docs/development/DEVELOPMENT_PLAN.md)** — план Backend разработки
- **[Техническое задание Frontend](./docs/development/FRONTEND_TASKS.md)** — ТЗ для Frontend
