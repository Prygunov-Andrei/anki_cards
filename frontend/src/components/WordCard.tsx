...
import { Trash2, RefreshCw, ImageIcon, MoreVertical, ArrowRight } from 'lucide-react';
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
/**
 * Компонент WordCard - красивая карточка с медиа-контентом
      ...
      <Card className="overflow-hidden hover:shadow-lg transition-shadow">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end">
                {onRegenerateImage && (
                  ...
                  >
                    <RefreshCw className={`mr-2 h-4 w-4 ${regeneratingImage ? 'animate-spin' : ''}`} />
                ...
                {onRegenerateAudio && (
                  ...
                  >
                    <RefreshCw className={`mr-2 h-4 w-4 ${regeneratingAudio ? 'animate-spin' : ''}`} />
        ...
        <div className="p-4 space-y-3">
          ...
          <div className="flex items-center gap-2">
            {/* Аудио плеер */}
            {audioUrl && audioUrl !== 'null' && audioUrl !== 'undefined' && audioUrl.trim() !== '' && (
